...
-- Obter o número médio, average, de issues abertos em repositórios cujo owner é um utilizador, ou seja, repositórios pertencentes a organizações ou equipas não serão tidos em consideração.
